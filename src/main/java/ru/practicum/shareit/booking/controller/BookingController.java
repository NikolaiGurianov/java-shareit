...
public class BookingController {
    ...
    @GetMapping
    public List<BookingDto> findBookingByBooker(@RequestHeader("X-Sharer-User-Id") Long bookerId,
    ...
    @GetMapping("/owner")
    public List<BookingDto> findBookingByOwner(@RequestHeader("X-Sharer-User-Id") Long ownerId,
                                               @RequestParam(required = false, defaultValue = "ALL") State state) {
